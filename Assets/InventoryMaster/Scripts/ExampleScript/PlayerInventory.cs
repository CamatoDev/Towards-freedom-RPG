...
public class PlayerInventory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        moneyText = GameObject.Find("PlayerMoneyTxt").GetComponent<Text>();
    ...
    void Update()
    {
        ...
        moneyText.text = "Money : " + playerMoney + " fcfa";

        // Gain de niveau grace au système d'expérience
        if (currentXP >= maxXP)
        {
            float xpBonus = currentXP - maxXP;
            playerLevel += 1;
        ...
        experienceBar.fillAmount = pourcentageXP;
        xpText.text = currentXP + " / " + maxXP;

        // bloquer la valeur de la vie max
